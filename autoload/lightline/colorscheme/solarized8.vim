...
" Author: zinil
" Comment: custom solarized8(https://github.com/lifepillar/vim-solarized8)
"          theme for lightline
" =============================================================================
...
" [zinil]: my custom colors
" tab
let s:extra0 = [ '#004052', s:cuicolors.base02[s:cuiindex]]
let s:extra1 = [ '#00212B', s:cuicolors.base02[s:cuiindex]]
...
let s:p.normal.middle = [ [ s:base1, s:extra1 ] ]
let s:p.inactive.middle = [ [ s:base01, s:extra1 ] ]
let s:p.tabline.left = [ [ s:base03, s:base00 ] ]
let s:p.tabline.tabsel = [ [ s:base0, s:base03 ] ]
let s:p.tabline.middle = [ [ s:base0, s:extra0 ] ]
