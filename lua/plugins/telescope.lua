...
spec.keys = {
    ...
    {'<leader>gB', function() require('telescope').git_branches() end, desc = 'Branches' },
    {'<leader>gC', function() require('telescope').git_commits() end, desc = 'Commits' },
    {'<leader>gS', function() require('telescope').git_status() end, desc = 'Status' },
}
